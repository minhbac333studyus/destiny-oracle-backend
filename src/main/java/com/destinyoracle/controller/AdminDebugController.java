...
public class AdminDebugController {
    ...
    @Operation(summary = "Docker volume storage usage",
               description = "Returns disk usage for all tracked Docker volumes (Mem0, Ollama, PostgreSQL).")
    public ResponseEntity<Map<String, Object>> getStorageUsage() {
        return ResponseEntity.ok(systemHealthService.getStorageUsage());
    }
    ...
    public ResponseEntity<Map<String, Object>> getCardDebug(
        ...
        pipeline.put("imagePrompts", stages.stream()
